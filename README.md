...
![JavaScript Screenshot](code-samples/JAVASCRIPT.png)
...
![TypeScript Screenshot](code-samples/TYPESCRIPT.png)
...
![CSS Screenshot](code-samples/CSS.png)
...
![HTML Screenshot](code-samples/HTML.png)
...
![Rust Screenshot](code-samples/RUST.png)
...
![C++ Screenshot](code-samples/CPP.png)
...
![Go Screenshot](code-samples/GO.png)
...
![Java Screenshot](code-samples/JAVA.png)
...
![C# Screenshot](code-samples/CSHARP.png)
...
![Python Screenshot](code-samples/PYTHON.png)
...
![Ruby Screenshot](code-samples/RUBY.png)
...
![PHP Screenshot](code-samples/PHP.png)
...
![Lua Screenshot](code-samples/LUA.png)
...
![Dart Screenshot](code-samples/DART.png)
...
![SQL Screenshot](code-samples/SQL.png)
...
code --install-extension catppuccin-dark-pro-1.0.0.vsix
```
